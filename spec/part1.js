  ...
  describe('Part I', function() {
    ...
    describe('uniq', function() {
      ...
      it('should handle iterators that work with a sorted array', function() {
        ...
        var numbers_unsorted = [4,3,4,2,1,2];
        /*
        console.time('_uniq(numbers, true, iterator)');
        _.uniq(numbers, true, iterator)
        console.timeEnd('_uniq(numbers, true, iterator)');

        console.time('_uniq(numbers, false, iterator)');
        _.uniq(numbers, false, iterator)
        console.timeEnd('_uniq(numbers, false, iterator)');

        console.time('_uniq(numbers_unsorted, true, iterator)');
        _.uniq(numbers_unsorted, true, iterator)
        console.timeEnd('_uniq(numbers_unsorted, true, iterator)');

        console.time('_uniq(numbers_unsorted, false, iterator)');
        _.uniq(numbers_unsorted, false, iterator)
        console.timeEnd('_uniq(numbers_unsorted, false, iterator)');
        */
